...
public class PluginInfoProviderImpl implements PluginInfoProvider {
	...
	private static final String PLUGIN_DESCRIPTION =
			"Reinforce your ReportPortal instance with Slack integration. Be informed about test result finish in real time in your Slack channel. Link to <a href=\"https://reportportal.io/docs/plugins/Slack\">Documentation</a>";
